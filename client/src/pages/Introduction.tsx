        ...
        <div className="max-w-7xl mx-auto mb-16">
          <Card className="bg-white/10 backdrop-blur-lg border border-white/20 shadow-2xl">
            <CardHeader className="text-center pb-8">
              <CardTitle className="text-4xl font-bold text-white mb-4">Academic Research Project</CardTitle>
            ...
            <CardContent className="p-10">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-blue-500/20 p-6 rounded-xl border border-blue-400/40 hover:border-blue-300/60 transition-all duration-300">
                  <h3 className="text-2xl font-semibold mb-6 text-blue-300 flex items-center">
                ...
                {/* Supervision Details */}
                <div className="bg-green-500/20 p-6 rounded-xl border border-green-400/40 hover:border-green-300/60 transition-all duration-300">
